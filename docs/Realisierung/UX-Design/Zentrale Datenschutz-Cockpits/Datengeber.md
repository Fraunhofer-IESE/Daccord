...
Darunter befindet sich im Abschnitt "Meine Dienste" ein Überblick, über diejenigen Dienste des Ökosystems, die genutzt werden und Daten verarbeiten. Sow ird es Nutzern ermöglicht, schnell zu erkennen, welche Dienste Zugriff auf die eigenen Daten haben und welche Datenkategorien von diesen verarbeitet werden.
